...
import { expertiseData as defaultExpertiseData } from '@/data/siteData';

export default function Expertise({ data = defaultExpertiseData }) {
  ...
  return (
    <section id='Treatments' className="bg-[#FFF7F1] text-[#192c27] py-16 sm:py-20 font-sans border-t border-black/5">
      <div className="max-w-[1340px] mx-auto px-5 sm:px-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              aria-label="Previous expertise item"
            >
            ...
            <button
              ...
              className="w-10 h-10 rounded-full bg-white flex items-center justify-center border border-gray-200 shadow-sm text-gray-700 hover:bg-gray-50 active:scale-95 transition-all duration-200"
              aria-label="Next expertise item"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        {/* Horizontal Slider of Expertise Cards */}
        <div
          ref={scrollRef}
          ...
          {items.map((item) => (
            ...
            >
              <div>
                ...
                <h3 className="text-lg sm:text-[19px] font-bold text-[#192c27] mb-2 text-left leading-snug">
                  {item.title}
                </h3>
